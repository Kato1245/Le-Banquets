...
const Profile = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setMessage({
                type: "error",
                text: err.friendlyMessage || "Error al actualizar el perfil",
            });
        } finally {
            setLoading(false);
        }
                    ...
                    <div className="lg:col-span-1">
                        <div className="card bg-base-100 shadow-2xl border border-primary/10 overflow-hidden">
                            ...
                            <div className="card-body items-center text-center pt-8 pb-10">
                                ...
                                <h2 className="card-title text-3xl font-extrabold">{user.nombre}</h2>
                                ...
                                <div className="w-full space-y-4">
                                    ...
                                    <div className="flex justify-between items-center text-sm">
                                        ...
                                        <span className="font-mono text-xs opacity-70">#{user.id?.slice(-8)}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <div className="card bg-base-100 shadow-xl border border-primary/5">
                            <div className="card-body p-8">
                                ...
                                {message.text && (
                                    <div className={`alert ${message.type === 'success' ? 'alert-success' : 'alert-error'} mb-6 shadow-sm`}>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="form-control w-full">
                                            <label className="label">
                                                <span className="label-text font-bold">Documento</span>
                                            </label>
                                            <input
                                                type="text"
                                                value={user.documento || "No registrado"}
                                                disabled
                        ...
                        <div className="card bg-base-200 shadow-sm mt-8 border border-primary/5">
                            <div className="card-body p-6">
                                <h4 className="font-bold text-sm opacity-50 uppercase tracking-wider mb-4">Seguridad y Cuenta</h4>
                                <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                                    <div className="text-center sm:text-left">
                                        <p className="font-bold">Contraseña</p>
                                        <p className="text-sm opacity-70">Actualiza tu contraseña regularmente para mayor seguridad</p>
                                    </div>
