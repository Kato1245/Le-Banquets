            ...
            {slides.map((slide, index) => (
                ...
                >
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <a onClick={prevSlide} className="btn btn-circle bg-base-100 bg-opacity-50 border-none hover:bg-opacity-80">❮</a>
                        <a onClick={nextSlide} className="btn btn-circle bg-base-100 bg-opacity-50 border-none hover:bg-opacity-80">❯</a>
                    </div>
                </div>
            ))}
