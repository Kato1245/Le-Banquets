    ...
    <>
      <div className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 group">
        <figure className="relative h-56 overflow-hidden">
          <img
            src={banquete.imagenes?.[0] || 'https://via.placeholder.com/400x300?text=No+Image'}
            alt={banquete.nombre}
        ...
        <div className="card-body p-6">
          <div className="flex justify-between items-start mb-2">
            <h2 className="card-title text-xl font-bold truncate">{banquete.nombre}</h2>
          </div>
          ...
          <div className="flex items-center gap-2 text-sm text-base-content/70 mb-4">
            ...
            <span className="truncate">{banquete.direccion || banquete.ubicacion}</span>
          </div>
