...
const BanqueteCitaModal = ({ banquete, isOpen, onClose }) => {
  ...
  return (
    <dialog open className="modal modal-open items-center justify-center p-4">
            ...
            <div className="space-y-6">
              <div className="p-6 bg-white/5 backdrop-blur-xl rounded-[2rem] border border-white/10">
                ...
                <p className="text-xs leading-relaxed opacity-70">
                  Nuestras visitas guiadas tienen una duración aproximada de 45
                  minutos donde conocerás cada rincón del salón y las opciones
                  de personalización.
                </p>
              </div>
        ...
        <div className="flex-1 p-8 md:p-14 relative bg-base-100">
          ...
          <header className="mb-10">
            ...
            <p className="text-sm opacity-40 font-bold tracking-widest uppercase">
              Completa los detalles para tu visita personalizada
            </p>
          </header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="form-control">
                <div className="relative group">
                  <span className="absolute left-5 top-1/2 -translate-y-1/2 text-primary font-bold z-10 group-focus-within:scale-110 transition-transform">
                    📅
                  </span>
                  <input
                    type="date"
      ...
      <div
        className="modal-backdrop bg-black/80 backdrop-blur-xl"
        onClick={onClose}
      ></div>
    </dialog>
  );
