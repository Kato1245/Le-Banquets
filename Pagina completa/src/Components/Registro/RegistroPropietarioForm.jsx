// src/Components/Registro/RegistroPropietarioForm.jsx
...
const RegistroPropietarioForm = () => {
    ...
    return (
        ...
        className="mt-8 flex flex-col gap-6 max-w-md mx-auto p-8 bg-base-200 rounded-2xl shadow-lg">
            ...
            <div className="form-control">
                <label className="label">
                    <span className="label-text font-semibold">RUT o Identificación Fiscal *</span>
                </label>
                <input
                    {...register("rut", {
                        required: "Este campo es requerido"
            ...
            <div className="form-control">
                <label className="label">
                    <span className="label-text font-semibold">Documento de Identidad *</span>
                </label>
                <input
                    {...register("documento", {
                        required: "Este campo es requerido"
            ...
            <div className="form-control">
                <label className="label">
                    <span className="label-text font-semibold">Teléfono de Contacto</span>
                </label>
                <input
                    {...register("telefono")}
