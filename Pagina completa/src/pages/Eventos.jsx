// src/pages/Eventos.jsx - Versión completa con 15 eventos y barra de búsqueda
    ...
    <div className="min-h-screen bg-base-100 py-8">
      <div className="max-w-7xl mx-auto px-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="mt-6">
                      <h4 className="font-bold mb-2">Testimonios</h4>
                      <div className="space-y-3">
                        {selectedEvento.testimonios.map((testimonio, index) => (
                          <div key={index} className="bg-base-200 p-3 rounded-lg">
                            <p className="italic">"{testimonio}"</p>
                          </div>
                        ))}
                      </div>
                    </div>
                  ...
                  <div>
                    <div className="space-y-4">
                      ...
                      <div>
                        <h4 className="font-bold mb-2">Servicios adicionales</h4>
                        <ul className="list-disc list-inside space-y-1">
                          {selectedEvento.serviciosAdicionales.map((servicio, index) => (
                            <li key={index}>{servicio}</li>
                          ))}
                        </ul>
                      </div>
                      ...
                      <div className="mt-6">
                        <button className="btn btn-primary w-full">Solicitar cotización personalizada</button>
                        <button className="btn btn-outline w-full mt-2">Descargar brochure</button>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="mt-16 bg-base-200 rounded-lg p-8">
          <h2 className="text-3xl font-bold text-center mb-8">¿Cómo contratar nuestros servicios?</h2>
          <div className="steps steps-vertical lg:steps-horizontal">
            <div className="step step-primary">
              <div className="step-circle">1</div>
              <div className="step-content">
                <h3 className="font-bold">Consulta inicial</h3>
                <p>Comunica tus necesidades y preferencias</p>
              </div>
            </div>
            <div className="step step-primary">
              <div className="step-circle">2</div>
              <div className="step-content">
                <h3 className极="font-bold">Cotización</h3>
                <p>Recibe una propuesta detallada y personalizada</p>
              </div>
            </div>
            <div className="step step-primary">
              ...
              <div className="step-content">
                ...
                <p>Ajustamos todos los detalles según tus preferencias</p>
              </div>
            </div>
            <div className="step step-primary">
              ...
              <div className="step-content">
                ...
                <p>Firma de contrato y pago de reserva</p>
              </div>
            </div>
            <div className="step">
              <div className="step-circle">5</div>
              <div className="step-content">
                <h3 className="font-bold">Ejecución</h3>
                <p>Disfruta de tu evento perfectamente organizado</p>
              </div>
            </div>
          </div>
          
          <div className="text-center mt-8">
            <button className="btn btn-primary">Iniciar proceso de contratación</button>
          </div>
        </div>
      </div>
    </div>
